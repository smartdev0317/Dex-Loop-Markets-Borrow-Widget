...
import useSwapAsset from "hooks/useSwapAsset"
...
export const useInitSwapAsset = () => {
  const swapAsset = useSwapAsset()
  const setSwapAsset = useSetRecoilState(swapAssetState)

  useEffect(() => {
    setSwapAsset(swapAsset)
  }, [swapAsset, setSwapAsset])
}
...
export const useAlertByNetwork = () => {
  ...
  return (
    window.location.hostname === "terra-dev.loop.finance"
  )
}
